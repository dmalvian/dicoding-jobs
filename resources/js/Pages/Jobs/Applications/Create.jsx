                    ...
                    <div className="w-full grid grid-cols-1 lg:grid-cols-[1.2fr,2fr] gap-6">
                        ...
                        <div>
                            ...
                            <form onSubmit={submit}>
                                ...
                                <div className="mt-4">
                                    <InputLabel className="text-base" forInput="phone" value="Nomor Telepon" />
                                ...
                                <div className="mt-4">
                                    <InputLabel className="text-base" forInput="cover_letter" value="Cover Letter" />
                                ...
                                <div className="mt-4">
                                    <InputLabel className="text-base" forInput="cv_link" value="Link ke CV/Portfolio" />
